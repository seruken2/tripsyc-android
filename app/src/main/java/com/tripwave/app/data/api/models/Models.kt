package com.tripwave.app.data.api.models
...
data class User(
    ...
    // Deeper group-fit axes (Tier-3 in iOS). Each is a string enum on
    // the server but the Android UI just stores the raw string so we
    // can swap segmented options without breaking persistence.
    val heatTolerance: String? = null,
    val altitudeTolerance: String? = null,
    val motionSickness: String? = null,
    val jetLagTolerance: String? = null,
    val refundableOnly: Boolean? = null,
    val tippingNorm: String? = null,
    val frontingComfort: String? = null,
    val maxComfortableFront: Int? = null,
    val morningRoutineMinutes: Int? = null,
    val phoneCoveragePref: String? = null,
    val preferredTransport: String? = null,
    val preferredFlightTime: String? = null,
    val partyScale: String? = null,
    val aloneTimeHoursPerDay: Int? = null,
    val introvertExtravert: Int? = null,
    val conversationEnergy: String? = null,
    val cookingSkill: String? = null,
    val navigationPreference: String? = null,
    val planningPatience: String? = null,
